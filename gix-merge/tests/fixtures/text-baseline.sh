...
# TODO: figure out diff-iculties
mkdir no-change-add-diff-issue-tbd
(cd no-change-add-diff-issue-tbd
...
# TODO: figure out diff-iculties
mkdir no-change-remove-diff-issue-tbd
(cd no-change-remove-diff-issue-tbd
...
EOF
  ...
  mkdir marker-newline-handling
  (cd marker-newline-handling
  	printf "1\\r\\n2\\r\\n3" >base.blob
  	printf "1\\r\\n2\\r\\n4" >ours.blob
  	printf "1\\r\\n2\\r\\n5" >theirs.blob
  )
...
for dir in  simple \
            ...
            complex/marker-newline-handling \
